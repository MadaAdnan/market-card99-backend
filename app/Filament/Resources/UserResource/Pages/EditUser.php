...
class EditUser extends EditRecord
{
   ...
   public function mount($record): void
   {
      ...
      $user=User::findOr($record);
       //dd(auth()->user()->users->pluck('id')->toArray(),$user->user_id,in_array($user->user_id,auth()->user()->users->pluck('id')->toArray()));
       abort_if($user->user_id!=auth()->id() && in_array($user->user_id,auth()->user()->users->pluck('id')->toArray()) && !auth()->user()->hasRole('super_admin'),404);
