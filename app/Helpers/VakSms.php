...
class VakSms implements \App\InterFaces\ServerInterface
{
    ...
    public function getPhoneNumber( Program $program): Order
    {
        ...
        try {
            $response = \Http::get("https://vak-sms.com/api/getNumber/?apiKey=" . $server->api . "&service=" . $program->code . "&country=" . $countryCode);
        } catch (\Exception $e) {
