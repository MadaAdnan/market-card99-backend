...
// قيم العلامة التي تريد البحث عنها
        $tag_values = $this->email; // قم بتعديلها حسب القيم التي تريدها
...
// بناء الجسم للطلب
        $fields = array(
           ...
           // 'included_segments' => ['All'],
            'contents' => $message,
            'small_icon'=>isset($this->data['img'])?$this->data['img']:Setting::first()?->getFirstMediaUrl('image'),
            'filters' => [
                [
                    'field' => 'tag',
                    'key' => 'email',
