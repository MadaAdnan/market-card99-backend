                ...
                <form wire:submit.prevent="submit">
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model.lazy="currency" class="form-control @error('currency') is-invalid @enderror">
                            <option value="{{\App\Enums\CurrencyEnum::USD->value}}">{{\App\Enums\CurrencyEnum::USD->status()}}</option>
                            <option value="{{\App\Enums\CurrencyEnum::TR->value}}">{{\App\Enums\CurrencyEnum::TR->status()}}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model.lazy="type" class="form-control @error('type') is-invalid @enderror">
                            <option value="{{\App\Enums\ProductTypeEnum::DEFAULT->value}}">{{\App\Enums\ProductTypeEnum::DEFAULT->status()}}</option>
                            <option value="{{\App\Enums\ProductTypeEnum::NEED_ACCOUNT->value}}">{{\App\Enums\ProductTypeEnum::NEED_ACCOUNT->status()}}</option>
                            <option value="{{\App\Enums\ProductTypeEnum::NEED_ID->value}}">{{\App\Enums\ProductTypeEnum::NEED_ID->status()}}</option>
                        </select>
                        @error('type')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="">كود الطلب من LIFECACH</label>
